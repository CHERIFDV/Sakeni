...
session_start();
 ...
 $creeannonce->ajouteannonce($_POST['tr'],$_POST['etat'],$_POST['typeb'],$_POST['address'],$_POST['region'], $_POST['ville'],$_POST['Meublé'],$_POST['Garage'],$_POST['jardin'],$_POST['piscine'],$_POST['telephone'],$_POST['titre'],$_POST['desc'],$_POST['prix'],$image,$_SESSION['id_user'],$images,$_POST['chambre']);
