...
$liste=$getliste->fav($_POST['Appartements'],$_POST['Maisons'],$_POST['Villasmaisonsdeluxe'],$_POST['Nouveau'],$_POST['Bonetat'],$_POST['Arenover'],$_POST['Location'],$_POST['Locationvacance'],$_POST['Vente'],$_POST['Région'],$_POST['Ville'],$_POST['Meublé'],$_POST['Garage'],$_POST['jardin'],$_POST['piscine'],$_POST['pmax'],$_POST['pmin'],$_POST['imneuf'],$_POST['nbch']);

}else{
    $liste=$getliste->favliste();
    $i=2;
}
