...
$getliste=$user;
 ...
 if(isset($_GET['Location'])||isset($_GET['Locationvacance'])||isset($_GET['Vente'])||isset($_GET['imneuf'])){
    $_POST['Location']=$_GET['Location'];
    $_POST['Locationvacance']=$_GET['Locationvacance'];
    $_POST['Vente']=$_GET['Vente'];
    $_POST['imneuf']=$_GET['imneuf'];
   
 }

if(isset($_POST['Appartements'])||isset($_POST['Maisons'])||isset($_POST['Villasmaisonsdeluxe'])||isset($_POST['Nouveau'])||isset($_POST['Bonetat'])||isset($_POST['Arenover'])||isset($_POST['Location'])||isset($_POST['Locationvacance'])||isset($_POST['Vente'])||isset($_POST['Région'])||isset($_POST['Ville'])||isset($_POST['Meublé'])||isset($_POST['Garage'])||isset($_POST['jardin'])||isset($_POST['piscine'])||isset($_POST['pmax'])||isset($_POST['pmin'])||isset($_POST['imneuf'])||isset($_POST['nbch'])){
$liste=$getliste->getliset($_POST['Appartements'],$_POST['Maisons'],$_POST['Villasmaisonsdeluxe'],$_POST['Nouveau'],$_POST['Bonetat'],$_POST['Arenover'],$_POST['Location'],$_POST['Locationvacance'],$_POST['Vente'],$_POST['Région'],$_POST['Ville'],$_POST['Meublé'],$_POST['Garage'],$_POST['jardin'],$_POST['piscine'],$_POST['pmax'],$_POST['pmin'],$_POST['imneuf'],$_POST['nbch']);

}else{
    $liste=$getliste->getliset1();
    $i=2;
}
...
?>
    ...
    <form action="liste.php" id="submit" method="post">
        ...
        <div class="list-group-item">
              <h3> Type de bien </h3>
                      ...
                      <i class="fas fa-building"></i> Appartements</span>
                        ...
                        <input type="number" class="count c1" name="nbch" <?php if(isset($_POST['nbch'])){  echo "value='".$_POST['nbch']."'";}else{ echo "value='0'";}?>>
...
echo"<li><a href='../pdescussion/produitdescussion.php?bien=".$value['id_bien']."' data-tip='Quick View'><i class='fa fa-eye'></i></a></li>";

echo"<li><a idbien='".$value['id_bien']."' class='favori' data-tip='Add to Wishlist' ><i id='favor".$value['id_bien']."' "; if ($user->favornot($value['id_bien'])){ echo" style='color: red;'";} echo" class='fa fa-shopping-bag'></i></a></li>";

echo"<li><a idbien='".$value['id_bien']."' class='like'  data-tip='Add to Cart'><i id='like".$value['id_bien']."'";  if ($user->likeornot($value['id_bien'])){ echo" style='color: red;'";} echo" class='fa fa-heart'></i> </a></li>";
echo"</ul>";
