                  ...
                  <aside class="sm-side">
                      <div class="user-head">
                          <a class="inbox-avatar" href="javascript:;">
                              <img  width="64" hieght="60" <?php    if (1==1) { echo "src='".$compte['imageu']."'"; }?>>
                          </a>
                          <div class="user-name">
                              <h5><a href="#"><?php echo $compte['first_name']." ".$compte['last_name']; ?></a></h5>
                              <span><a href="#"><?php echo $compte['email']; ?></a></span>
                          </div>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                                <?php
                                foreach ($messagesn as $key => $value) {
                                ...
                                echo "<td class='view-message  dont-show'><a  href='http://localhost:8080/pdescussion/produitdescussion.php?bien=".$value['id_bien']."&res=".$value['send_id']."'>ANNONCE</td>";
                                echo " <td class='view-message'><a  href='http://localhost:8080/pdescussion/produitdescussion.php?bien=".$value['id_bien']."&res=".$value['send_id']."'>".$value['messages']."</td>";
                                echo " <td class='view-message  inbox-small-cells'><i class='fa fa-paperclip'></i></td>";
                                echo " <td class='view-message  text-right'>".$value['date']."</td>";
                                echo " </tr>";
